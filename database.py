...
if __name__ == "__main__":
    new_table("user_cards",
              'id_num int PRIMARY KEY AUTO_INCREMENT,card_id VARCHAR(300),card_type VARCHAR(300),owner_name VARCHAR(300),issue_date VARCHAR(300),role VARCHAR(300), rank VARCHAR(300) ,phone_number VARCHAR(300) ,expiration_date VARCHAR(300)')
